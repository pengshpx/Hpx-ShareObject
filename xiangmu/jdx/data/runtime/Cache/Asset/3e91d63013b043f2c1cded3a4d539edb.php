...
.eidt_uphoto .no {
    background: url("/admin/themes/simplebootx/Public/assets/images/upload_pic.jpg") no-repeat scroll center center #FBFBFB;
    border: 1px solid #CCCCCC;
    height: 98px;
    overflow: hidden;
    text-indent: -2000em;
...
.eidt_uphoto .del{
	...
	width:15px;
	height:15px;
	background:url("/admin/themes/simplebootx/Public/assets/images/upload_del.png") no-repeat;
	right:1px;
	top:1px;
	overflow:hidden;
	text-indent:-2000em;
...
/*上传选择按钮*/
#btupload,.addnew{
	background: url("/public/js/swfupload/images/swfBnt.png") no-repeat; float:left; margin-right:10px;width:75px; height:28px; line-height:28px;font-weight:700; color:#fff;
}
#btupload{ 
    ...
    <div class="pop_cont">
      <div class="">
        <div class="edit_uping"> 
            ...
            <span class="num">最多上传<em> <?php echo ($file_upload_limit); ?></em> 个附件
				<!--,单文件最大 <em>20240 KB</em>
				，<em style="cursor: help;" title="可上传格式：jpg,jpeg,gif,png,bmp">支持格式jpg,jpeg,gif,png,bmp</em>-->
			</span>
        </div>
