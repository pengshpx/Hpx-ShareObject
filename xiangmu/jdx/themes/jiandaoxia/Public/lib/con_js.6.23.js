...
/*alert ,confirm 封装*/
   ...
   var go_confirm=function(msg,func){
   	    if ($(".confirm_box").length) {
            $(".confirm_box .content p:first").text(msg).parents(".alert_box").css({"opacity":"1","width":"100%","height":"100%"})
        }
        else {
...
/*评星效果*/
	var set_stars=function(stars_box,img_url,stars_num,img_wid,style){
		...
		stars_box.each(function(){
		  ...
		  $(this).append("<img class='star' src='"+img_json.filled+"' width='"+img_wid+"' style='display:inline-block;margin-right:4px'/>")
...
//	set_stars($(".set_stars"),img_url,5,25,"show")
